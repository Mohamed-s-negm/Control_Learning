...
data_path = script_dir / "Coupled Van der Pol Oscillators — Realistic Mechan" / "attack1_coupled_mvdp_test.csv"
...
model = ps.SINDy(
    ...
    differentiation_method=ps.SmoothedFiniteDifference(smoother_kws={'window_length': 51})
)
